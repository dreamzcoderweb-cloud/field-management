            ...
            <form action="" method="GET">
                ...
                <div class="row g-2 justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-auto d-grid">
                            <label>&nbsp;</label>
                            <a href="{{ route('admin.salereport.index') }}" class="clear-search btn btn-danger">
                                &#10005;
                            </a>
                        </div>
                        <div class="col-auto d-grid">
                            <label>&nbsp;</label>
                            <button type="submit" class="btn btn-success" formaction="{{ route('admin.salereport.export') }}"
                                formmethod="POST">
                                Generate Report
                            </button>
                        </div>
                    ...
                    <tbody>
                        @foreach ($sales as $sale)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.salereport.show', $sale?->id) }}"
