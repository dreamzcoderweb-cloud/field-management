        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <div class="report-card">
                    ...
                    <p><strong>Amount:</strong> <span class="param">{{ number_format($sale?->product_amount, 2) }}</span></p>
            ...
            <div class="col-md-4">
                <div class="report-card">
                    ...
                    <p><strong>Product Price:</strong> <span class="param">{{ number_format($sale?->product_amount, 2) }}</span></p>
                    <p><strong>Interest Price:</strong> <span class="param">{{ number_format($sale?->amount - $sale?->product_amount, 2) }}</span></p>
                    <p><strong>Total Cost:</strong> <span class="param">{{ number_format($sale?->amount, 2) }}</span></p>
                    <p><strong>Paid Amount:</strong> <span class="param text-success">{{ number_format($sale?->paid_amount, 2) }}</span></p>
                    <p><strong>Balance Amount:</strong> <span class="param text-danger">{{ number_format($sale?->balance, 2) }}</span></p>
                </div>
            </div>
        </div>
