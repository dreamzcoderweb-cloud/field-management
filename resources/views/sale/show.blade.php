        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                @if ($sale->is_exchangable == 1)
                    <div class="row mt-3">
                        <h6>Exchangeable Product</h6>
                        <div class="col-md-3">
                            <p><strong>Exchangable Item :</strong> <span
                                    class="param text-primary">{{ $sale?->exchangable_item }}</span></p>
                        </div>
                        <div class="col-md-3">
                            <p><strong>Exchangable Amount :</strong> <span
                                    class="param text-primary">{{ $sale?->exchangable_amount }}</span></p>
                        </div>
                        <div class="col-md-3">
                            <p><strong>Vehicle Registration Number :</strong> <span
                                    class="param text-primary">{{ $sale?->vehicle_number }}</span></p>
                        </div>
                        <div class="col-md-3">
                            <p><strong>Vehicle Registration Year :</strong> <span
                                    class="param text-primary">{{ $sale?->vehicle_year }}</span></p>
                        </div>
                    </div>
                @endif
            </div>
