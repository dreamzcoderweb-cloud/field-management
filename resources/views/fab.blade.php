    ...
    <div class="container-fluid support-chat">
        <div class="card bg-white">
            ...
            <div class="card-footer d-flex align-items-center gap-2 border-top ps-3 pe-4 py-3">
                <form id="aiForm" class="d-flex align-items-center flex-1 gap-3 border rounded-pill px-4">

                    <input class="form-control outline-none border-0 flex-1 fs--1 px-0" type="text" placeholder="Write message" id="aiMessage"/>

                </form>
                <button type="submit" class="btn p-0 border-0 send-btn" id="aiBtn"><span class="fa-solid fa-paper-plane fs--1"></span></button>
            </div>
        </div>
    </div>
    <button class="btn p-0 border border-200 btn-support-chat"><span class="fs-0 btn-text text-primary text-nowrap">Ai Chat</span><span class="fa-solid fa-circle text-success fs--1 ms-2"></span><span class="fa-solid fa-chevron-down text-primary fs-1"></span></button>
</div>
--}}
