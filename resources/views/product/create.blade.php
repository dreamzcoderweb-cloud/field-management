                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                ...
                                <select id="product_type" name="product_type" class="form-select mb-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="price" name="price" class="form-control" value="{{ old('price') }}"
                                        oninput="validatePriceInput(this)" placeholder="Enter price (e.g., 123.45)" />
                        ...
                        <div class="form-group d-flex justify-content-end">
                            ...
                            <a href="{{ route('productList') }}" class="btn btn-danger"
